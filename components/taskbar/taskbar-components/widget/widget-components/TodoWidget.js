  ...
  return (
    <div className="bg-zinc-800/80 w-full h-full rounded p-4 mt-4">
      ...
      <div className="px-4 p-4">
        ...
        {/* Task 2 */}
        <a
          href="https://www.linkedin.com/in/oussama-bouhrir-8492a6239/"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* Task 3 */}
        <a
          href="https://twitter.com/BouhrirOussama"
          target="_blank"
          rel="noopener noreferrer"
          className="w-full h-10 rounded bg-zinc-100/20 px-2 flex items-center mt-4 hover:bg-zinc-100/30 transition-all ease-in-out"
        >
        ...
        {/* Task 4 */}
        <a
          href="https://github.com/Bouhrir/ft_transcendence"
          target="_blank"
          rel="noopener noreferrer"
